...
SEG_SUB_DIR="seg_1_2"
TEST_SUB_DIR="MultiCL1LOO50_0.01_3x4"
PHASE_NUMBER=16
ATLAS_SIZE=5
	...
	do
		...
		do
			...
			do
				...
				FEATURE_IMGS="${FEATURE_IMGS} ${SUSAN_DIR}/susan${PHASE[0]}.nii.gz \
				${SUSAN_DIR}/susan${PHASE[1]}.nii.gz \
				${SUSAN_DIR}/susan${PHASE[2]}.nii.gz "
...
do
	...
	do
		...
		FEATURE_IMGS="${SUSAN_DIR}/susan${CURRENT_PHASE}.nii.gz "
