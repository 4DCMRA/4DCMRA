	...
	do
		...
		do
			...
			do
				...
				MS_IMGS="${MS_IMGS} ${MANUAL_DIR}/seg${CURRENT_PHASE}.nii.gz"
				AS_IMGS="${AS_IMGS} ${LOO_JLF_PATH}/InvTrans/${CASE_DIR}/seg${CURRENT_PHASE}.nii.gz"

				FEATURE_IMGS="${FEATURE_IMGS} ${N4_DIR}/img${CURRENT_PHASE}.nii.gz ${SUSAN_DIR}/susan${CURRENT_PHASE}.nii.gz"
...
do
	...
	do
		...
		FEATURE_IMGS="${N4_DIR}/img${CURRENT_PHASE}.nii.gz ${SUSAN_DIR}/susan${CURRENT_PHASE}.nii.gz"
