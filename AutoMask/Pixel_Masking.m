...
save_nii(make_nii(uint16(nmlz(ims_sum)*1024)),['C:\Users\pangjx\Desktop\Additional_Atlases\im',num2str(ind),'.nii']);
%
...
save_nii(make_nii(uint16(nmlz(mask_manual)*1024)),['C:\Users\pangjx\Desktop\Additional_Atlases\mask',num2str(ind),'.nii']);
