...
SYNCONVERGENCE="[500x250x150x50,1e-6,10]"
...
SYNMETRICS="$SYNMETRICS --metric
      CC[${FIXEDIMAGES[0]},${MOVINGIMAGES[0]},1,${CCRADIUS},Random,0.5]"
SYNMETRICS="$SYNMETRICS --metric
      MI[${FIXEDIMAGES[2]},${MOVINGIMAGES[2]},1,32]"
SYNMETRICS="$SYNMETRICS --metric
      Demons[${FIXEDIMAGES[3]},${MOVINGIMAGES[3]},1,32]"
