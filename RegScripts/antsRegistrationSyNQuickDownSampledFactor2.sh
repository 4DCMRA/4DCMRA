...
if [[ $ISLARGEIMAGE -eq 1 ]];
  then
    RIGIDCONVERGENCE="[1000x500x0,1e-6,10]"
    RIGIDSHRINKFACTORS="8x4x2"
    RIGIDSMOOTHINGSIGMAS="4x3x2vox"

    AFFINECONVERGENCE="[1000x500x0,1e-6,10]"
    AFFINESHRINKFACTORS="8x4x2"
    AFFINESMOOTHINGSIGMAS="4x3x2vox"

    SYNCONVERGENCE="[100x100x100,1e-6,10]"
    SYNSHRINKFACTORS="10x8x6"
    SYNSMOOTHINGSIGMAS="5x4x3vox"
  fi
tx=Rigid
