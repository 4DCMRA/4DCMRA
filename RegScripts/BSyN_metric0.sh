...
SYNCONVERGENCE="[1000x500x250x100x100,1e-7,10]"
...
# Images: 0: N4 Bias corrected image
#         1: Auto-masks
#         2: N4 & Susan images
#         3: Laplacian Images
RIGIDSTAGE="--initial-moving-transform [${FIXEDIMAGES[1]},${MOVINGIMAGES[1]},1] \
            --transform ${tx}[0.1] \
            --metric MI[${FIXEDIMAGES[2]},${MOVINGIMAGES[2]},1,32,Random,0.25] \
            --convergence $RIGIDCONVERGENCE \
            --shrink-factors $RIGIDSHRINKFACTORS \
            --smoothing-sigmas $RIGIDSMOOTHINGSIGMAS"

AFFINESTAGE="--transform Affine[0.1] \
             --metric MI[${FIXEDIMAGES[2]},${MOVINGIMAGES[2]},1,32,Random,0.5] \
...
SYNMETRICS="$SYNMETRICS --metric
      MI[${FIXEDIMAGES[0]},${MOVINGIMAGES[0]},0.5,${CCRADIUS}]"
SYNMETRICS="$SYNMETRICS --metric
      Demons[${FIXEDIMAGES[2]},${MOVINGIMAGES[2]},0.25,${CCRADIUS},Random,0.25]"
SYNMETRICS="$SYNMETRICS --metric
      Demons[${FIXEDIMAGES[3]},${MOVINGIMAGES[3]},0.25,${CCRADIUS},Random,0.25]"
